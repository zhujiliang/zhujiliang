...
class BasePage(object):
    ...
    def back_to_homepage(self):
        time.sleep(1)
        if self.driver.element_if_exists('id', 'cn.xq.shareelb:id/close_rl'):
            self.driver.element('id', 'cn.xq.shareelb:id/close_rl').click()
            time.sleep(1)
        if self.driver.element_if_exists('id', 'cn.xq.shareelb:id/back'):
        ...
        if self.driver.element_if_exists('id', 'cn.xq.shareelb:id/back'):
            self.driver.element('id', 'cn.xq.shareelb:id/back').click()
            time.sleep(1)
        if self.driver.element_if_exists('id', 'cn.xq.shareelb:id/iv_avatar'):
            self.driver.back()
            time.sleep(1)
